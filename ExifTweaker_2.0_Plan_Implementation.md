...
-   nouvelle suite de 18 tests : 16 réussis localement et 2 tests
    d'intégration ExifTool réservés au runner Windows ;
-   dernier workflow GitHub de référence réussi avec 8 tests sur 8 ; le
    workflow renforcé doit maintenant valider les 18 tests, la commande
...
1.  Exécuter le workflow GitHub renforcé et conserver son run comme
    validation Windows de l'ExifTool embarqué et des 18 tests.
